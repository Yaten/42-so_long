...
/*   Updated: 2021/12/02 17:06:27 by prafael-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Function copies the SRC to DEST, while doesn't reach the SIZE.
 *
 * @param dest strign to be receive the copy.
...
/**
 * @brief Function tries to concat the SRC to DEST,while doesn't reach the SIZE.
 *
...
/**
 * @brief Function transform lowercase letter into uppercase.
 *
...
/**
 * @brief Function transform uppercase letter into lowercase.
 *
 * @param c to be verify
 * @return int
 */
 ...
 * @return 0 for equal || > 0 for s1 || 0 < for s2
 */
 ...
 * @param n compare until this byte.
 * @return 0 for equal || > 0 for str || 0 < for ptr
 */
 ...
 * @param set the characters to be trimmed in s1.
